...
### Phase 7 — MD 업로더 ✅ (2026-03-22)
- [x] 로컬 .md 파일을 브라우저에서 선택 → GitHub `content/posts/`에 자동 커밋
- [x] 동일 파일명 존재 시 덮어쓰기 / 취소 확인 모달
- [x] Google OAuth 로그인 + 어드민 이메일 검증으로 접근 제어
- [x] 커밋 완료 후 Vercel 자동 배포 연계
- 어드민 URL: `/admin/upload`
- 기획서: `docs/phase7-md-uploader.md`
